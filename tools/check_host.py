...
def main():
    ...
    modules = {'text': ['src/game/text.c'],
               ...
               'service': ['src/game/service.c', 'src/game/inventory.c', 'src/script/vm.c',
                           'src/overworld/overworld.c'],
               'inventory': ['src/game/inventory.c'],
               'loop': ['src/game/loop.c', 'src/game/service.c', 'src/game/inventory.c',
                        'src/game/window.c', 'src/game/dialogue.c', 'src/script/vm.c',
                        'src/overworld/overworld.c'],
               'interact': ['src/game/interact.c', 'src/game/service.c', 'src/game/inventory.c',
                            'src/script/vm.c', 'src/overworld/overworld.c'],
               'runner': ['src/game/runner.c', 'src/game/interact.c', 'src/game/loop.c',
                          'src/game/service.c', 'src/game/inventory.c', 'src/game/window.c',
                          'src/game/dialogue.c', 'src/overworld/input_control.c',
