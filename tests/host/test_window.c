...
int main(void) {
    ...
    lg_window_init(&w, text, sizeof text, widths, 0, 0, capture, &seen);
    ...
    lg_window_init(&w, plain, sizeof plain, widths, 0, 0, capture, &seen);
